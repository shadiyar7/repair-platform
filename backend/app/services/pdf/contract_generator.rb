module Pdf
  class ContractGenerator
    ...
    def generate
      ...
      text "5.6. В случае просрочки поставки более чем на 15 (пятнадцать) календарных дней Покупатель вправе в одностороннем порядке отказаться от исполнения Договора с требованием возврата уплаченной суммы и начисленной неустойки.", align: :justify, size: 10
      move_down 10
